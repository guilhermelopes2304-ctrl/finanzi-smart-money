            ...
            <SectionReveal>
              <div className="relative overflow-hidden rounded-[32px] border border-white/8 bg-[#181818] p-5 sm:p-7">
                ...
                <div className="relative mt-7 grid gap-3 sm:grid-cols-[1.15fr_.85fr]">
                  ...
                  <div className="rounded-[24px] border border-[#FF5A1F]/15 bg-[#2A1710] p-5"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-[#FF9A78]">Leitura rápida</p><p className="mt-4 text-sm leading-6 text-white/70">Você já tem <strong className="text-white">R$ 327</strong> comprometidos nos próximos dias.</p><div className="mt-5 h-2 overflow-hidden rounded-full bg-white/8"><div className="h-full w-[72%] rounded-full bg-[#FF5A1F]" /></div></div></div>
                </div>
              </div>
            </SectionReveal>
          </div>
