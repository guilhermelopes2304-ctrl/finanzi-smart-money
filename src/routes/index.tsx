        ...
        <div className="mx-auto flex h-[68px] max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-full bg-[#5B5CE2] px-4 py-2.5 text-xs font-bold text-[#FCFBF7] transition-transform hover:-translate-y-0.5 sm:px-5 sm:text-sm"
            >
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:gap-20">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href={checkout("annual")}
                  className="inline-flex h-14 items-center justify-center gap-2 rounded-full bg-[#5B5CE2] px-7 text-sm font-bold text-[#FCFBF7] transition-transform hover:-translate-y-0.5 sm:text-base"
                >
                  QUERO O FINANZZI <ArrowRight className="size-4" />
                </a>
                <a
                  href="#como-funciona"
                  className="inline-flex h-14 items-center justify-center gap-2 rounded-full border border-[#E4E7EF] bg-white/75 px-7 text-sm font-bold text-[#151827] transition-colors hover:bg-white sm:text-base"
                >
                ...
                <div className="rounded-[2rem] bg-[#F4F5F8] p-4 sm:p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm font-semibold text-[#151827]">
                        como falaria com alguém.
                      </p>
                    </div>
                    <span className="grid size-9 place-items-center rounded-full bg-[#5B5CE2] text-[#FCFBF7]">
                  ...
                  <button
                    type="button"
                    onClick={nextExample}
                    className="mt-5 w-full rounded-[1.35rem] bg-[#151827] px-4 py-4 text-left text-sm font-semibold text-white shadow-sm"
                  >
                  ...
                  <div className="mt-4 rounded-[1.35rem] border border-[#E4E7EF] bg-white p-4">
                    ...
                    <div className="mt-3 flex items-end justify-between gap-4">
                      <div>
                        <p className="font-display text-3xl font-semibold tracking-[-0.05em] text-[#151827]">
                          R$ 82,00
                        </p>
                        <p className="mt-1 text-xs font-medium text-[#3F4658]">
                          Mercado · Alimentação
                        </p>
                      </div>
                  ...
                  <div className="mt-4 rounded-[1.35rem] bg-[#5B5CE2] p-4">
                    <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#FCFBF7]">
                      e depois...
                    </p>
                    <p className="mt-1 font-display text-xl font-semibold leading-tight text-[#FCFBF7]">
          ...
          <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-14">
            <Reveal className="relative overflow-hidden rounded-[2rem] border border-[#E4E7EF] bg-white shadow-[0_22px_60px_rgba(21,24,39,.10)]">
              ...
              <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-white/30 bg-[#151827]/82 px-4 py-3 text-white backdrop-blur-md">
                <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#EEF0FF]">
            ...
            <Reveal delay={90} className="max-w-xl">
              ...
              <p className="mt-5 text-base leading-7 text-[#3F4658] sm:text-lg">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-[#3F4658]">
                Um gasto, uma conta, uma assinatura ou uma dúvida. Escreva como você falaria. O
                resto fica por conta do FINANZZI.
              </p>
            </div>
            <div className="mt-12 grid gap-4 md:grid-cols-3">
              {[
                ...
                [
                  ...
                  "ORGANIZE",
                  "“Netflix 39,90 todo mês”",
                  "Ele entende que é recorrente e lembra depois.",
                ],
                [
                  "03",
                  "ORIENTE",
                  "“posso gastar 200?”",
                  "Ele olha seus compromissos e responde com contexto.",
                ],
              ].map(([number, title, example, description]) => (
                <article
                  key={number}
                  className="rounded-[1.8rem] border border-[#E4E7EF] bg-white p-6 shadow-[0_14px_36px_rgba(25,30,22,0.04)]"
                >
                  <span className="text-xs font-black tracking-[0.15em] text-[#667085]">
                    {number}
                  </span>
          ...
          <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            ...
            <div className="rounded-[2rem] bg-[#FCFBF7] p-6 text-[#151827] sm:p-8">
              ...
              <div className="mt-6 divide-y divide-[#E4E7EF]">
                {[
                  ...
                  <div key={item} className="flex items-center justify-between py-4">
                    ...
                    <span className="rounded-full bg-white px-3 py-1 text-[10px] font-bold text-[#667085]">
                      {index + 2} dias
                    </span>
                  </div>
                ))}
              ...
              <div className="mt-5 rounded-2xl bg-[#5B5CE2] p-4">
                ...
                <p className="mt-1 font-display text-3xl font-semibold tracking-[-0.05em] text-[#FCFBF7]">
                  R$ 1.523,80
                </p>
        ...
        <section className="px-4 py-20 sm:px-6 sm:py-28">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div>
              ...
              <a
                href={checkout("annual")}
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#5B5CE2] px-6 py-3.5 text-sm font-bold text-[#FCFBF7] transition-transform hover:-translate-y-0.5"
              >
            ...
            <div className="grid gap-4">
              ...
              {[
                ...
                <div
                  key={text}
                  className="rounded-[1.6rem] border border-[#E4E7EF] bg-white p-5 shadow-[0_12px_34px_rgba(25,30,22,0.04)]"
                >
        ...
        <section className="px-4 pb-20 sm:px-6 sm:pb-28">
          <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.2rem] bg-[#151827] px-6 py-12 text-center text-white sm:px-12 sm:py-16">
            ...
            <a
              href={checkout("annual")}
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#5B5CE2] px-7 py-4 text-sm font-bold text-[#FCFBF7] transition-transform hover:-translate-y-0.5 sm:text-base"
            >
              QUERO O FINANZZI <ArrowRight className="size-4" />
            </a>
          </div>
...
function PricingCard({
  ...
  return (
    <article
      className={`rounded-[2rem] border p-6 sm:p-8 ${featured ? "border-[#151827] bg-[#151827] text-white shadow-[0_24px_60px_rgba(20,24,18,0.15)]" : "border-[#E4E7EF] bg-white text-[#151827]"}`}
    >
      <div className="flex items-start justify-between gap-4">
        <div>
          <p
            className={`text-xs font-bold uppercase tracking-[0.15em] ${featured ? "text-[#5B5CE2]" : "text-[#667085]"}`}
          >
            {plan.name}
          </p>
        ...
        {featured && (
          <span className="rounded-full bg-[#5B5CE2] px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.12em] text-[#FCFBF7]">
            mais vantajoso
          </span>
        )}
      </div>
      ...
      <ul className={`space-y-3 text-sm ${featured ? "text-white/80" : "text-[#3F4658]"}`}>
        {[
          ...
          <li key={item} className="flex items-start gap-2">
            <Check
              className={`mt-0.5 size-4 shrink-0 ${featured ? "text-[#5B5CE2]" : "text-[#5B5CE2]"}`}
            />
            {item}
          </li>
        ))}
      ...
      <a
        href={checkoutHref}
        className={`mt-8 inline-flex h-12 w-full items-center justify-center gap-2 rounded-full text-sm font-bold transition-transform hover:-translate-y-0.5 ${featured ? "bg-[#5B5CE2] text-[#FCFBF7]" : "bg-[#4546C8] text-[#FCFBF7]"}`}
      >
