...
function AuthPage() {
  ...
  const subtitle = isLogin ? "Entre e continue cuidando do seu dinheiro sem complicação." : "Digite seu e-mail e enviaremos um link seguro para redefinir sua senha.";
