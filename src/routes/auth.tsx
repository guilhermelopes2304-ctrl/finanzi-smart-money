      ...
      <aside className="relative hidden overflow-hidden bg-[#181818] lg:flex lg:flex-col lg:justify-between">
        <div className="relative p-10 xl:p-14">
          ...
          <div className="mt-24 max-w-xl animate-fin-fade-up" style={{ animationDelay: "100ms" }}>
            <span className="inline-flex items-center gap-2 rounded-full bg-[#181818] px-3.5 py-2 text-xs font-semibold text-[#FF5A1F] shadow-sm">
              <Sparkles className="size-3.5 text-[#FF5A1F]" /> Seu dinheiro, do jeito que você fala.
            </span>
            <h2 className="mt-6 max-w-lg font-display text-5xl font-semibold leading-[1.02] tracking-[-0.055em] text-white xl:text-6xl">
            ...
            <div className="mt-9 space-y-3 text-sm text-white">
              {[
                ...
                >
                  <span className="grid size-6 place-items-center rounded-full bg-[#FF5A1F] text-white">
        ...
        <div className="relative px-10 pb-10 xl:px-14 xl:pb-14">
          <div className="rounded-[1.75rem] border border-white/10 bg-[#181818] p-5 shadow-[0_18px_55px_rgba(21,24,39,.08)] animate-fin-scale-in">
            <div className="flex items-center gap-4">
              <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-[#FF5A1F] text-[10px] font-black uppercase tracking-[0.14em] text-white">
                FIN
              </span>
              <div>
                ...
                <p className="mt-1 text-sm text-white/60">Assinatura criada · vence amanhã</p>
              </div>
            </div>
            <div className="mt-4 h-1.5 overflow-hidden rounded-full bg-[#181818]">
              <div className="h-full w-3/4 rounded-full bg-[#FF5A1F]" />
            </div>
          </div>
      ...
      <main className="relative flex min-h-screen flex-col">
        <div className="relative flex items-center justify-between px-4 py-4 sm:px-6">
          <Link
            ...
            className="grid size-11 place-items-center rounded-full border border-white/10 bg-[#181818] text-white/60 shadow-sm transition-colors hover:border-[#FF5A1F] hover:text-[#FF5A1F]"
          >
        ...
        <div className="relative mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-4 py-8 sm:px-6">
          ...
          <div className="rounded-[1.75rem] border border-white/10 bg-[#181818] p-5 shadow-[0_18px_55px_rgba(21,24,39,.08)] animate-fin-scale-in sm:p-7">
              ...
              {isLogin && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      className="text-xs font-bold text-[#FF5A1F] transition-opacity hover:opacity-75"
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-1 top-1 grid size-10 place-items-center rounded-lg text-white/60 transition-colors hover:text-[#FF5A1F]"
                    >
            ...
            <div className="mt-5 flex items-center justify-center gap-1 text-sm">
              {isLogin ? (
                <>
                  <span className="text-white/60">Ainda não tem acesso?</span>
                  <Link to="/oferta" className="font-bold text-[#FF5A1F]">
                    Ver oferta
                  </Link>
                </>
              ) : (
          ...
          <div className="mt-6 flex items-center justify-center gap-2 text-xs text-white/60 animate-fin-fade-up">
            <ShieldCheck className="size-4 text-[#FF5A1F]" /> Os seus dados são tratados com
            segurança.
          </div>
        </div>
      </main>
