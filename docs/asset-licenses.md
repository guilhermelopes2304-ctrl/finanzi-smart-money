# FINANZZI — registo de assets visuais
...
Os assets `public/fin-mascote-*-indigo.png` são versões de direção de arte da personagem própria já existente. Foram preservados estados, expressões, silhueta, transparência e dimensões 512×512, com a paleta da marca índigo e detalhe coral. Não são fotografias de terceiros.

## Observação de uso

A aplicação não sugere endosso de pessoas, marcas ou plataformas presentes nas fotografias. A fotografia real é um elemento contextual da landing, enquanto o produto e os screenshots/demonstrações permanecem elementos próprios do FINANZZI.
