...
This file is the checklist used when touching user-facing screens.
...
- Remaining routes should be audited incrementally before large visual refactors so loading/error/empty states are not lost.
